...
sample_df = pd.DataFrame({
    "Hour":[1,2,3,4,1,2,3,4,5,9],
    "AREA NAME":["A","B","A","C","A","B","C","C","A","B"],
    "Crm Cd Desc":["Desc1","Desc2","Desc1","Desc2","Desc1","Desc2","Desc1","Desc2","Desc1","Desc2"],
    "Vict Sex":["M","F","M","F","M","F","M","F","M","F"],
    "Vict Descent":["W","H","B","A","W","H","B","A","W","H"],
    "Premis Desc":["House","Street","House","Street","House","Street","House","Street","House","Street"],
    "Weapon Desc":["Gun","Knife","Gun","Knife","Gun","Knife","Gun","Knife","Gun","Knife"],
    "Status Desc":["Open","Open","Open","Open","Open","Open","Open","Open","Open","Open"],
    "DayOfWeek":["Mon","Tue","Wed","Thu","Fri","Sat","Sun","Mon","Tue","Wed"],
    "TimeOfDay":["Night","Night","Day","Day","Night","Night","Day","Day","Night","Night"]
})
...
X_train, X_test, y_train, y_test = train_test_split(X_encoded, y_hour, test_size=0.2, random_state=42, stratify=y_hour)
